...
def get_events_df(client_id, data_store, date_range_list, experiment_id):
    ...
    if mobile_records is not None and len(mobile_records) > 0:
        ...
        events_df.columns = ["variation_id", "session_count", "date", "iso_date"]
    return events_df
...
def get_session_count_per_variation_over_time(data_store, client_id, experiment_id, timezone_str):
    ...
    for variation_name in variation_names:
        ...
        session_count = d["session_count"].tolist()
