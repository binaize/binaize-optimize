...
class ExperimentAnalytics(object):
    @classmethod
    def get_session_count_per_variation_over_time(cls, data_store, client_id, experiment_id, timezone_str):
        return get_session_count_per_variation_over_time(data_store, client_id, experiment_id,
                                                         timezone_str=timezone_str)

    @classmethod
    def get_visitor_count_per_variation_over_time(cls, data_store, client_id, experiment_id, timezone_str):
        return get_visitor_count_per_variation_over_time(data_store, client_id, experiment_id,
                                                         timezone_str=timezone_str)

    @classmethod
    def get_conversion_rate_per_variation_over_time(cls, data_store, client_id, experiment_id, timezone_str):
